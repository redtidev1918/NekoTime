...
The detailed guides are written in Chinese. Start from the
[documentation home](/README.md), or jump directly to:
...
| [平台兼容性](/docs/COMPATIBILITY.md) | Per-platform compatibility |
| [Linux 故障排查](/docs/LINUX_TROUBLESHOOTING.md) | Linux troubleshooting |
| [测试指南](/docs/TESTING.md) | Testing guide |

## Links

- Repository: <https://github.com/redtidev1918/NekoTime>
- Releases: <https://github.com/redtidev1918/NekoTime/releases>
- Changelog: <https://github.com/redtidev1918/NekoTime/blob/main/CHANGELOG.md>
